%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%	MEDIAEVAL 2018 PREDICTING MEDIA MEMORABILITY TASK: DEVELOPMENT SET
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Please note that the task wiki contains all the needed information to understand and use the provided development set:
https://github.com/multimediaeval/2018-Predicting-Media-Memorability-Task/wiki

-----------------------------------------------------------------------------------------------------------------------------------
# GROUND TRUTH (folder "ground-truth")
-----------------------------------------------------------------------------------------------------------------------------------

Ground truth is provided in file ground-truth_dev-set.csv.
...
-----------------------------------------------------------------------------------------------------------------------------------
The development set contains 8,000 short videos.
